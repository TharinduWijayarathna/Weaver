            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card overflow-hidden h-500px h-xl-750px rounded-0"
                        style="background-image:url({{ asset('assets/images/shop/bg/01.jpg') }}); background-position: center left; background-size: cover;">
                        <!-- Bg overlay -->
                ...
                <div class="swiper-slide">
                    <div class="card overflow-hidden h-500px h-xl-750px rounded-0"
                        style="background-image:url({{ asset('assets/images/shop/bg/02.jpg') }}); background-position: center left; background-size: cover;">
                        <!-- Bg overlay -->
                        <div class="bg-overlay bg-dark opacity-5 d-lg-none"></div>
                        <!-- Card image overlay -->
                        <div class="card-img-overlay d-flex align-items-center">
            ...
            <div class="row g-4 g-sm-5">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="card p-0 h-100"
                        style="background-image:url({{ asset('assets/images/shop/bg/03.jpg') }}"; background-position:
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card border bg-transparent overflow-hidden p-0 h-100">
                        ...
                        <div class="card-header bg-light rounded m-2">
                            <img src="{{ asset('assets/images/shop/02.png') }}" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card border bg-transparent overflow-hidden p-0 h-100">
                        <!-- Image -->
                        <div class="card-header bg-light rounded m-2">
                            <img src="{{ asset('assets/images/shop/03.png') }}" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card border bg-transparent overflow-hidden p-0 h-100">
                        <!-- Image -->
                        <div class="card-header bg-light rounded m-2">
                            <img src="{{ asset('assets/images/shop/01.png') }}" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card border bg-transparent overflow-hidden p-0 h-100">
                        <!-- Image -->
                        <div class="card-header bg-light rounded m-2">
                            <img src="{{ asset('assets/images/shop/06.png') }}" alt="">
                        </div>
...
Features END -->
    ...
    <!-- =======================
Product START -->
    <section class="bg-parallax position-relative" style="background:url({{ asset('assets/images/shop/bg/04.jpg') }}"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card border overflow-hidden p-0 h-100">
                                    ...
                                    <div class="card-header bg-transparent pb-0">
                                        <img src="{{ asset('assets/images/shop/08.png') }}" alt="">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card border overflow-hidden p-0 h-100">
                                    ...
                                    <!-- Image -->
                                    <div class="card-header bg-transparent pb-0">
                                        <img src="{{ asset('assets/images/shop/09.png') }}" alt="">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card border overflow-hidden p-0 h-100">
                                    ...
                                    <!-- Image -->
                                    <div class="card-header bg-transparent pb-0">
                                        <img src="{{ asset('assets/images/shop/07.png') }}" alt="">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card border overflow-hidden p-0 h-100">
                                    ...
                                    <!-- Image -->
                                    <div class="card-header bg-transparent pb-0">
                                        <img src="{{ asset('assets/images/shop/10.png') }}" alt="">
                                    </div>
                ...
                <div class="col-lg-6 mb-6 mb-lg-0">
                    ...
                    <div class="card bg-light border overflow-hidden p-xl-0">
                        <div class="row align-items-center">
                            <!-- Image -->
                            <div class="col-sm-4">
                                <img src="{{ asset('assets/images/shop/game.png') }}" class="ms-n5" alt="">
                            </div>
                            <!-- Title and content -->
                            <div class="col-sm-8">
                                <div class="card-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card bg-light overflow-hidden h-100 p-0">
                        ...
                        <div class="card-footer bg-light px-sm-8 px-md-9 px-lg-7 px-xl-8 pt-0">
                            <img class="mb-n7" src="{{ asset('assets/images/shop/watch-01.png') }}" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-xl-4 mb-5 mb-lg-0">
                    <h2 class="mb-4">Their Impressive Product Collections</h2>
                    <a class="icon-link icon-link-hover heading-color text-primary-hover" href="#">Explore all
                        brands<i class="bi bi-arrow-right"></i> </a>
                </div>
                ...
                <div class="col-lg-7 text-center ms-auto">
                    <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-4 g-md-6">
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/01.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/02.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/03.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/04.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/05.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/06.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/07.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                        <!-- Image -->
                        <div class="col">
                            <a href="#"><img src="{{ asset('assets/images/client/08.svg') }}"
                                    class="grayscale" alt="client-img"></a>
                        </div>
                    </div>
                </div>
